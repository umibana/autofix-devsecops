...
export function HistorialSalida() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const url = `http://localhost:8090/api/historial_reparacion/salida/${idAuto}/${fechaSalida}/${horaSalida}`;
    ...
    return (
        <div>
            <h2>Registro de Salida en Historial de Reparación</h2>
            <form id="salidaHistorialReparacionForm" onSubmit={handleSubmit}>
                ...
                <button type="submit">Guardar Salida en Historial</button>
            </form>
